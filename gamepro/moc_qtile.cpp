...
static const char qt_meta_stringdata_Qtile[] = {
    "Qtile\0"
};
...
const QMetaObjectExtraData Qtile::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Qtile::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Qtile,
      qt_meta_data_Qtile, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Qtile::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Qtile))
